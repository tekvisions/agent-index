...
SITE_URL = "https://agents.kymatalabs.com"
SITE_NAME = "The Agent Index"
FONTS = ("https://fonts.googleapis.com/css2?family=Sora:wght@500;600;700;800"
...
KSTRIP = ('<div class="kstrip"><div class="wrap">'
          ...
          '</div></div>')
NODE = '<span class="node"><i></i><i></i><i></i><i></i><i></i></span>'
...
<header><div class="wrap head-row">
  <div class="brand"><a href="/">{NODE}<span class="disp">Agent <em>Index</em></span></a></div>
  <div class="head-actions"><a href="/">← All frameworks</a><button class="theme-btn" id="theme" aria-label="Toggle theme">◐</button></div>
</div></header>
...
<footer><div class="wrap foot-row">
  <div class="blurb">{SITE_NAME} is a self-updating map of the agent-building stack — frameworks, multi-agent, orchestration & memory — recomputed daily from live GitHub signals. Part of <a href="https://indexes.kymatalabs.com">The Living Indexes</a> by Kymata Labs.</div>
